...
//sudo npm i -s express @google-cloud/compute
    ...
    'disks': [
        {
            ...
            'deviceName': "",
            'initializeParams': {
                'sourceImage': 'projects/cloudproject-255316/global/images/cloudproject-0',
...
router.post('/make', async function makeVMs(req, res) {
    ...
    zone.createVM(name, config)
        ...
        .then((data) => {
            ...
            console.log(`IP: ${pubIP} Please wait 20 seconds before sshing...`);
